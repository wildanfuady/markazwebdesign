        ...
        ?>
           <div class="form-group">
              <?php 
                ...
                $isi_testimoni = array('name' => 'isi_testimoni', 'class' => 'form-control', 'id' => 'markaz_editor', 'placeholder' => 'Masukan Testimoni...', 'value' => $testimoni->isi_testimoni);
            ...
            <div class="form-group">
              <?php 
                ...
                $who_is = array('name' => 'who_is', 'class' => 'form-control', 'placeholder' => 'Masukan Nama Anda', 'value' => $testimoni->who_is);
            ...
            <div class="form-group">
              <?php 
                ...
                $owner = array('name' => 'owner', 'class' => 'form-control', 'placeholder' => 'Masukan Nama Owner', 'value' => $testimoni->owner);
